...
# Pins to a stable combo: Python 3.10, torch 2.4.1+cu121, mamba-ssm 2.2.5, causal-conv1d 1.5.2
...
conda install -y -c pytorch -c nvidia pytorch==2.4.1 torchvision==0.19.1 torchaudio==2.4.1 pytorch-cuda=12.1 numpy==1.26.4 scipy==1.11.*
